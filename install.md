# cdmx-public-transportation guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `cdmx_public_transportation/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `cdmx_public_transportation` folder and use the modules inside your notebooks :
...
```python
from cdmx_public_transportation.utils.paths import data_dir
data_dir()
```
